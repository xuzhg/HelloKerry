...
namespace Microsoft.OData.Edm
{
    ...
    public static class ExtensionMethods
    {
        ...
        public static IEdmProperty FindProperty(this IEdmStructuredType structuredType, string propertyName, bool caseInsensitive)
        {
            ...
            //IDictionary<string, IEdmProperty> keyValuePairs = new Dictionary<string, IEdmProperty>(StringComparer.OrdinalIgnoreCase);
        ...
        public static IEdmProperty FindProperty2(this IEdmStructuredType structuredType, string propertyName, bool caseInsensitive)
        {
            EdmUtil.CheckArgumentNull(structuredType, "structuredType");
            EdmUtil.CheckArgumentNull(propertyName, "propertyName");
        ...
        public static IEdmProperty FindProperty3(this IEdmStructuredType structuredType, string propertyName, bool caseInsensitive)
        {
            EdmUtil.CheckArgumentNull(structuredType, "structuredType");
            EdmUtil.CheckArgumentNull(propertyName, "propertyName");
            ...
            var lookup = structuredType.Properties().ToLookup(p => p.Name, p => p, StringComparer.OrdinalIgnoreCase);

            var group = lookup[propertyName].ToArray();
            if (group.Length == 0)
            {
                return null;
            }
